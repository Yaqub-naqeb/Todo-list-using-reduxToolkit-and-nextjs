    ...
    <div>
     {modal.md&& <div className={` xs z-50 bg-black text-white fixed inset-0 bg-opacity-30 backdrop-blur-lg text-lg flex justify-center items-center`}>
      ...
      <div className="flex flex-col gap-14 items-center pb-10 relative">
        <h1 className=" w-full text-center bg-white py-5 text-Main font-bold text-lg ">
          Todo List
        </h1>
        ...
        >
          <div className="flex items-center align-middle justify-center gap-5 bg-[#af7eeb]  bg-Main text-white font-medium p-2 rounded-full">
            <div>
              <svg
